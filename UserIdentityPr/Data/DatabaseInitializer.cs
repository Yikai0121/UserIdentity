...
namespace UserIdentityPr.Data
{
    ...
    {
        public static void Seed(AlbumDbcontext context)
        {
                ...
                (new List<Album>
                    {
                        ...
                        new Album { Artist = "Megadeth", Title = "Peace Sells... but Who's Buying?", CoverUrl = "https://upload.wikimedia.org/wikipedia/en/4/40/Megadeth_-_Peace_Sells..._But_Who%27s_Buying-.jpg", Price = 9.99m, ReleaseDate = new DateTime(1989, 9, 19) },
